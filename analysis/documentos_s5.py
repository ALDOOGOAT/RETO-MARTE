...
while i<len(lines):
    ...
    if s.startswith('# '):
        ...
        if hero.exists(): story += [Spacer(1,12),Image(str(hero),width=510,height=286.875),Paragraph('Render digital V4. Sección de inspección; acceso y equipos por validar.',styles['Cell']),Spacer(1,14)]
        i+=1;continue
    if s.startswith('##'):
