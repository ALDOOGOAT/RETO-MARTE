...
for p in ['config/*.json','analysis/*.py','analysis/*.cjs','analysis/*.mjs',
          ...
          'docs/madrid/capturas-s3/*.png','docs/madrid/ensayos/*.csv','docs/madrid/COMPARACION-S3-S5.html',
          'prototipo-3d/vendor/*','prototipo-3d/milpa360-*.js','prototipo-3d/milpa360-simulador.html',
          'prototipo-3d/LEEME-P3.md','prototipo-3d/package*.json','prototipo/planos/P02*.html',
          'prototipo/planos/P03*.html','prototipo/planos/_estilo.css','prototipo/planos/madrid/*.html',
...
manifest.write_text(json.dumps({'estado':'Candidata S5 para revisión. B15-B19 y S6 abiertos; no entrega oficial.',
