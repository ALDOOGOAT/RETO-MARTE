...
y límites en `MEJORA-VISUAL-BILINGUE.md`.
...
| 4. Cultivo | La simulación muestra cómo una reducción de luz puede dañar las plantas y afectar cosechas. Son reglas ilustrativas, todavía sin calibración experimental. La comparación usa los mismos recursos para ambos calendarios. | The simulation shows how reduced light can damage crops and affect harvests. These are illustrative rules that have not been experimentally calibrated. Both planting schedules are compared using the same resources. |
| 5. Chiapas | Proponemos un piloto exploratorio para comparar riego manual y goteo aislable. Mediremos agua por cosecha y tiempo de trabajo. El sitio, el operador y los resultados siguen pendientes. | We propose an exploratory pilot comparing manual irrigation with isolatable drip irrigation. We would measure water per harvest and working time. The site, operator and results are still pending. |
| Detalle de aves | Las siete figuras explican el concepto del aviario. No acreditan capacidad para las 24 codornices propuestas ni bienestar animal. Alimentación, espacio, sanidad y operación requieren validación. | The seven figures explain the aviary concept. They do not establish capacity for the proposed 24 quail or animal welfare. Feed, space, hygiene and operation require validation. |

## Ensayo con el equipo

1. Presentar sin ayuda del autor y registrar duración real, dudas y partes difíciles de leer.
2. Probar el mismo archivo a 1080p en el proyector y equipo del evento; conservar equipo,
   navegador, GPU, calidad elegida, escena y resultado, sin sustituirlo por la prueba local.
3. Probar una pregunta en inglés sobre alimento, energía y validación. Responder con la
   ficha y su fuente. Evitar convertir el acabado visual en evidencia experimental.
