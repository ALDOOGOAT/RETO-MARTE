...
**Corte:** commit `c3e0ad3`, 15 sep 2026. Evidencia y cálculos en [`AUDITORIA.md`](AUDITORIA.md) y
...
|---|---|---|---|---|---|---|---|---|---|---|
| RU-01 | «plantas y animales van a trabajar juntos para que nada se desperdicie: lo que uno produce, el otro lo usa» | p.1 | UNACH 2026 | Obligatorio | Sistema | Balance de masa por flujo | Diagrama PLAN §4.1 y §7 | parcial | Sin balance cuantitativo (AUD C6) | Ing. Soporte Vital |
...
| RU-03 | «de él depende directamente la alimentación de la tripulación, que no puede recibir reabastecimiento» | p.1 | UNACH 2026 | Obligatorio (condición de diseño) | Cultivo · Aviario | Balance de kcal, proteína y micronutrientes por persona; provisiones de arranque | Ninguna; el PLAN §13 admite «no alimenta a seis» | pendiente | Fracción cubierta sin calcular (AUD C11) | CMO + Ing. Soporte Vital |
...
| RU-P2-04 | «puede ser un biodigestor o compostaje con microorganismos» | p.1 | UNACH 2026 | **Ejemplo** | Tratamiento | Revisión documental | Biodigestor de dos cámaras + BSF (PLAN §4.3) | cumplido con evidencia (documental) | Ninguna sobre la elección; la viabilidad está en RU-P2-02/03 | — |
| RU-P3-01 | Usar la energía y el abono de la Parte 2 para alimentar la zona de cultivo | p.2 | UNACH 2026 | Obligatorio | Cultivo | Balance de energía por subsistema; ruta digestato → riego con dosis | Tuberías f_biogas y f_riego (ILUS) | parcial | «Colchón térmico» sin demanda calculada; antorcha abierta en el simulador (AUD C5) | Ing. Soporte Vital |
...
| RU-E1 | Entregable: diseño del sistema animal-vegetal (cómo se conectan las tres partes) | p.2 | UNACH 2026 | Obligatorio | Memoria · Prototipo | Revisión documental con geometría única | PLAN §4; P02–P05; simulador | parcial | **Cinco diámetros activos** (AUD C1); acceso y trasvase no resueltos (C2, C3) | UX/UI |
...
| ID | Texto / paráfrasis fiel | Fuente y pág. | Autoridad / rev. | Oblig. o ejemplo | Subsistema | Método de verificación | Evidencia | Estado | Brecha | Responsable |
|---|---|---|---|---|---|---|---|---|---|---|
| MG-01 | Mantener con vida a una tripulación de **6 personas** | p.1 | Mars Challenge 2026 | Obligatorio (escenario) | Sistema | Cálculos por persona | Documentos usan 6 | parcial | Ratios por persona sin calcular | Ing. Soporte Vital |
| MG-02 | Misión de ida y vuelta de «aprox. 2 años, no porque vivan 2 años en Marte» | p.1; Guía p.32 | Mars Challenge 2026 | Obligatorio (escenario) | Operación | Definir fases (tránsito y superficie) y justificar la duración operativa | 730 soles en superficie (decisión del equipo) | pendiente | Escenario no justificado; 730 soles ≈ 750 días (AUD D4) | Científico Planetario |
...
| G-C3 | Diseño: bien pensado; el prototipo comunica cómo funciona | p.31 | Guía TGJ 2026 | Criterio | Prototipo | Geometría única, acceso y trasvase explicables | Simulador y planos | parcial | C1, C2, C3 | UX/UI |
...
| N-10 | Monitoreo en tiempo real de productos de combustión (CO, HCN, HCl, HF) [6024] | Anexo p.2 | Rev. E | Referencia | Uso del biogás | Diseño del equipo de aprovechamiento | El simulador muestra una antorcha abierta (L1598) | pendiente | Combustión en cabina sin diseño | Ing. Soporte Vital |
