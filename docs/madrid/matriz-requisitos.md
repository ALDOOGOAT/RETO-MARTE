...
| G-C3 | Diseño: bien pensado; el prototipo comunica cómo funciona | p.31 | Guía TGJ 2026 | Criterio | Prototipo | Geometría única, acceso y trasvase explicables | Simulador y planos, ya coherentes entre sí (P2) | parcial | C1 cerrado. Falta holgura vertical (B15, B16) y límite de manipulación del cartucho | UX/UI |
