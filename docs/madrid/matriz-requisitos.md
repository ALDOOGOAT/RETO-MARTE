...
| RU-E1 | Entregable: diseño del sistema animal-vegetal (cómo se conectan las tres partes) | p.2 | UNACH 2026 | Obligatorio | Memoria · Prototipo | Revisión documental con geometría única | PLAN §4; P02–P05; simulador | parcial | Cinco diámetros activos (AUD C1). P1 propone la arquitectura B, que resuelve acceso y trasvase en papel; falta llevarla a simulador y planos (P2) | UX/UI |
